...
export const useAuthService = () => {
    ...
    try {
      ...
      if (data.ok && data.data) {
        ...
        const sessionData = buildSessionData({
          ...
          persistent: mantenerSesion,
        })
        writeSession(sessionData, mantenerSesion)
  ...
  const refreshAuthToken = (accessToken) => {
    try {
      ...
      console.error('Error al refrescar token:', error?.message || error)
      clearSession()
    }
  }
